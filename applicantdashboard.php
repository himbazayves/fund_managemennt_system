...
<?php if($row['fund_status'] =="open") : ?> 
												<td><p>Fund ID:<?php echo  $row['fund_id'] ?> <br></p>
												<p>title:<?php echo  $row['title'] ?> <br></p>
												<p> Deadline:<?php echo  $row['deadline'] ?> <br></p>
                                                   
												<p> description:<?php echo  $row['description'] ?><br></p>
													<?php if ($deadline>$now) : ?> 
	                                              
													<p>	status: <span class="label label-success">active</span> </p>
                                                     
	                                                  <?php else : ?>
													  <p>  status: <span class="label label-danger">closed</span></p>
												...
												<a href="application.php?fund_id=<?php echo $row['fund_id']?>" class="btn btn-primary">Apply now</a>
