...
$qry=$conn->query("UPDATE  `women_grobal`.`fund` SET fund_status='$fund_status' WHERE fund_id=$fund_id ");
...
if($qry)
{
	echo "<script>alert('successfully Closed')</script>";
	echo"<script>location.href='admin_fund.php';</script>";

}
else
{
    echo "<script>alert('failed  to please try again')</script>";
}
}
					...
					<div class=" col-sm-12 col-lg-">
						...
						<div class="panel">
							<div class="panel-heading">
								<h3 class="panel-title">Close fund</h3>
...
<h5> Are you sure you want to close this fund to ads</h5>
...
<div class="form-group">
<a class="btn btn-success" href="admin_fund.php"> No </a>
